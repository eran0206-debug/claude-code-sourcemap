...
film = ["יום צילום כולל עד שלוש שעות צילום פעיל","כל שעה נוספת מעבר לכך תחויב ב-150 ₪","אם לאחר יום הצילום הצלם והעורך יעריכו שכמות התוכן שצולמה אינה מספיקה להפקת שלושת הסרטונים — תקבל הלקוחה יום צילום נוסף ללא עלות, באורך המתאים להשלמת התוכן לפי הערכת הצלם והעורך"]
